...
function remove (functionNames) {
  const selectors = this.filter((v) => {
    for (const functionName of functionNames) {
      // console.log("remove: ", this.contract.interface.getFunction(functionName).selector)
...
function get (functionNames) {
  const selectors = this.filter((v) => {
    for (const functionName of functionNames) {
      // console.log("get: ", this.contract.interface.getFunction(functionName).selector)
      if (v === this.contract.interface.getFunction(functionName).selector) {
        return true
      }
    }
